...
void enterShop()
{
    ...
    cout << "Welcome! Here you can see all the equipments" << endl;
    cout << "As long as you pay a good price, i could provide you with whatever you want" << endl;
    cout << "Would like to have a look?" << endl;
